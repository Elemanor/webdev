...
<div class="faq-section">
  <details>
    <summary>How long before listing should I waterproof?</summary>
    <p>Ideally 2-4 weeks before listing. This allows time for any finishing touches and ensures all documentation is ready for your listing package. However, we can complete most projects in 48 hours if needed.</p>
  </details>
  
  <details>
    <summary>Will waterproofing disrupt my home staging?</summary>
    <p>Our interior systems require minimal disruption. We work around staging schedules and can complete most work without affecting your home's presentation. Many sellers stage after waterproofing for best results.</p>
  </details>
  
  <details>
    <summary>What if no water issues are visible?</summary>
    <p>Even without visible issues, inspectors use moisture meters and look for potential problems. Preventive waterproofing shows buyers you're proactive and eliminates any water-related negotiation points.</p>
  </details>
  
  <details>
    <summary>Can I add the cost to my sale price?</summary>
    <p>Absolutely. Our data shows waterproofed homes sell for 2.4% more on average—typically 3-4x the waterproofing investment. It's a selling feature, not a cost.</p>
  </details>
  
  <details>
    <summary>What if I'm selling 'as-is'?</summary>
    <p>Even 'as-is' sales benefit from waterproofing. It expands your buyer pool, reduces lowball offers, and shows good faith. Many 'as-is' buyers still want basic protection.</p>
  </details>
</div>

## Your Next Step to a Profitable Sale

<div class="final-seller-cta">
