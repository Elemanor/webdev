...
<div id="booking-widget" class="consultation-booking">
...
## What We Can Diagnose Virtually
...
## Virtual Consultation Success Stories
...
<div class="faq-section">
  <details>
    <summary>How accurate is a virtual assessment?</summary>
    <p>Our virtual assessments are 94% accurate compared to in-person visits. Our experts know exactly what to look for and what questions to ask. If we need more information, we'll arrange an in-person follow-up at no charge.</p>
  </details>
  
  <details>
    <summary>What if my internet connection is poor?</summary>
    <p>No problem! We can conduct the consultation over regular phone while you send photos via text or email. We're flexible and work with whatever technology you have.</p>
  </details>
  
  <details>
    <summary>Do I need to show my whole house?</summary>
    <p>No, just your basement and possibly the exterior grade around your foundation. The consultation is focused only on areas affecting your basement water issues.</p>
  </details>
  
  <details>
    <summary>Can I get financing information virtually?</summary>
    <p>Absolutely! We can discuss all financing options, run payment calculations, and even start the application process during your virtual consultation.</p>
  </details>
  
  <details>
    <summary>What if I need emergency service?</summary>
    <p>For active flooding, call our emergency line at 416-XXX-XXXX. Virtual consultations are for non-emergency assessments and planning.</p>
  </details>
</div>
